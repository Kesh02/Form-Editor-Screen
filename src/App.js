...
//             <input
//               type="text"
//               value={emailTitle}  // Show the current email title in the input box
//               onChange={(e) => setEmailTitle(e.target.value)}  // Update email title state on change
...
//             <textarea
//               value={emailDescription}  // Show the current email description
//               onChange={(e) => setEmailDescription(e.target.value)}  // Update description state on change
